...
public abstract class SeekableInputStream extends InputStream implements ImageInputStream {
  ...
  /**
   * Finalizes this object prior to garbage collection. The <code>close</code> method is called to
  ...
  protected void finalize() throws Throwable {
    if (!isClosed)
      try {
        ...
        // This is a best-effort operation. If it fails, there's nothing we can do.
      }
   ...
   * @throws IOException if <code>getStreamPosition</code> throws an <code>IOException</code>
